...
const Chairman = () => {
  return (
    <div className="flex flex-col lg:flex-row xl:flex-row justify-center gap-4 border-2 rounded-lg w-11/12 p-2">
      ...
      <div className="flex flex-col">
        <h1 className="text-3xl text-center mt-3 font-semibold tracking-wide">
          Ravi Prakash Dahiya
        </h1>
        ...
        <div className="border-2 rounded-lg w-10/12 mx-auto flex flex-col  h-content shadow-2xl bg-gray-100 italic mt-4">
          <p className="mx-auto p-2 text-lg">
            ...
            <span className="text-red-500">to bring hope, help,</span> and
            humanity to those who need it most. Together,{" "}
            <span className="text-red-500">
              we can create a better, kinder world
            </span>{" "}
            for all.<span className="font-semibold text-red-500 ">”</span>
          </p>
  ...
  <a href="mailto:rjdahiya009@gmail.com" target="_blank" rel="noopener noreferrer">
    rjdahiya009@gmail.com
          ...
          <div className="flex items-center mt-2  gap-3">
            ...
            <a href="https://wa.me/916377119794" target="_blank">
              6377119794
            </a>
          </div>
