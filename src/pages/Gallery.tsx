      ...
      <div className=" w-11/12 mt-2 mx-auto flex flex-col items-center justify-evenly">
       ...
       <a
        ...
        <div className="flex flex-col items-center">
          <p className="text-center mt-1  text-3xl font-nautigal">📸 Gallery</p>
          <div className="w-32 border-2 border-pink-600 mt-2"></div>
        </div>
      </div>

      <p className="text-center text-gray-600 mb-5 max-w-2xl mx-auto mt-4">
        Here’s a snapshot of our work on the ground — providing meals, spreading
        compassion, and uplifting lives through heartfelt support. Witness our
        mission in motion.
      </p>
